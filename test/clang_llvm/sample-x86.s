...
.Ltmp3:
	...
	movl	$2, -12(%ebp)
	.loc	1 8 6                   # source.c:8:6
	xorl	%eax, %eax
	testb	%al, %al
	jne	.LBB0_2
# BB#1:
	.loc	1 10 3                  # source.c:10:3
.Ltmp4:
	incl	-12(%ebp)
.Ltmp5:
.LBB0_2:
	#DEBUG_VALUE: main:c <- [%EBP+-16]
	.loc	1 13 6                  # source.c:13:6
	movl	$3, -16(%ebp)
.Ltmp6:
	#DEBUG_VALUE: main:d <- [%EBP+-20]
	.loc	1 14 6                  # source.c:14:6
	movl	$4, -20(%ebp)
	jmp	.LBB0_3
	.align	16, 0x90
.LBB0_4:                                #   in Loop: Header=BB0_3 Depth=1
	.loc	1 18 3                  # source.c:18:3
.Ltmp7:
	incl	-8(%ebp)
.Ltmp8:
.LBB0_3:                                # =>This Inner Loop Header: Depth=1
	.loc	1 16 2 discriminator 1  # source.c:16:2
	cmpl	$4, -8(%ebp)
	jle	.LBB0_4
# BB#5:
.Ltmp9:
	#DEBUG_VALUE: main:e <- [%EBP+-24]
	.loc	1 21 6                  # source.c:21:6
	movl	$5, -24(%ebp)
.Ltmp10:
	#DEBUG_VALUE: main:f <- [%EBP+-28]
